...
const mockData = [
    ...
    },
    {
        ...
        paragraph: "House party, cheddar cheese, bacon, onion, mustard",
        rating: 4.5,
        price: 99.32,
    },
    {
    ...
    },
    {
        ...
        image: Image5,
        title: "Double Burger",
        paragraph: "Turkey, cheddar cheese, onion, lettuce, tomatoes, pickle",
        rating: 3,
        price: 79.18,
    },
    {
  ...
  return (
    <section className='menu_section'>
        <Container>
            ...
            <Row className="pt-5">
                <Col sm={6} lg={5}>
                    <div className="ads_box ads_img1 md-5 mb-md-0">
